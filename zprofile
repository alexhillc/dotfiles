...
# ATG 10.2.0.3 Development Environment [JDK 1.7]
...
### Edit PATH
export PATH="$PHP_HOME/bin:${ANT_HOME}/bin:${ECLIPSE_HOME}:${JBOSS_HOME}/bin:${JAVA_HOME}/bin:${ATG_HOME}/bin:${ORACLE_HOME}/bin:${DYNAMO_HOME}/bin:${MYSQL_HOME}/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/sbin"
